...
// Briefly bumped 20000 -> 60000 after two of these timed out under full-
// 79-file-suite load, then restored to 20000 once vitest.config.mts's
// maxWorkers cap fixed the actual cause (contention from ~32 concurrent
// workerd instances, not a per-test logic problem).
